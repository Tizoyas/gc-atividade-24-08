...
| CFG-005 Frequência Responsável pelo controle de frequência dos alunos.

| CFG-006 Acesso ao Sistema Responsável pelo login e controle de acesso dos usuários.

| CFG-007 Diagrama de Casos de Uso Responsável por representar as funcionalidades do portal sob a ótica dos operadores (arquivo: DiagramaCasosDeUso.uml).
